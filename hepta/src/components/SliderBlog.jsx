...
import backImage from "../assets/image/th.jpeg"; // background image for both sections
    ...
    >
      <div className="container mx-auto">
        <div className="text-center mb-8">
          <h2 className="text-8xl font-serif font-bold mt-40">Recent Blog Posts</h2>
          <p className="text-4xl font-sans text-white leading-relaxed mb-40">
